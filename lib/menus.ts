...
export type Restaurant={id:string;name:string;mark:string;subtitle:string;url:string;priceUrl?:string};
export const restaurants:Restaurant[]=[
 ...
 {id:'ganymeden',name:'Ganymeden',mark:'G',subtitle:'Roxengatan · Lunchrestaurang',url:'https://ganymeden.se/',priceUrl:'https://ganymeden.se/priser/'},
...
export type LunchPrice={amount:number;note?:string};
export type Menu={id:string;week:number|null;days:string[][];weekly:string[];checkedAt:string;error?:boolean;attemptedAt?:string;fetchFailed?:boolean;weekStart?:string;price?:LunchPrice;priceCheckedAt?:string;priceFetchFailed?:boolean};
